"""
mimic_receiver_v9.py - live receiver for the 36 inch robot (humanoid_v9).

    python sim36/build_humanoid_v9_scene.py     (once)
    python mimic_receiver_v9.py
...
SCENE = os.path.join(REPO_ROOT, "sim36", "humanoid_v9_scene.xml")
...
class ArmIK:
    def __init__(self, model):
        ...
        self.seed = {"L": _np.array([0.0, _np.pi, 0.0, 0.6]),
                     "R": _np.array([0.0, _np.pi, 0.0, 0.6])}
