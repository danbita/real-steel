"""
mimic_receiver_v6.py  —  drives the real shoulder module + real ATOM arm.

    python sim/build_humanoid_v6_scene.py      (once, after any CAD change)
    python mimic_receiver_v6.py
...
SCENE = os.path.join(REPO_ROOT, "sim", "humanoid_v6_scene.xml")
...
def main():
    if not os.path.exists(SCENE):
        raise SystemExit(
            f"scene not found: {SCENE}\nrun:  python sim/build_humanoid_v6_scene.py")
    ...
    print("Shoulder v2: pitch +/-90, abduction 0..185, twist +/-90 (roll-coupled).")
